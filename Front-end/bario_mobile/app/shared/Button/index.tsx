...
const Button: React.FC = ({ isDisabled, isLoading, text, onPress, icon }: Button): React.ReactElement => {
    return (
        <ButtonContainer disabled={isDisabled} onPress={onPress}>
            {!isLoading ? (
                <React.Fragment>
                    <IconLeft><Feather name={icon} color={Colors.primaryTextLight} size={20} /></IconLeft>
